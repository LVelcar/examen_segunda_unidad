...
walls.push(new Rectangulo(53, 132, 25, 2, "gray"));
walls.push(new Rectangulo(101, 96, 74, 2, "gray"));
...
walls.push(new Rectangulo(100, 210, 40, 2, "gray"));
walls.push(new Rectangulo(62, 298, 76, 2, "gray"));
walls.push(new Rectangulo(15, 329, 52, 2, "gray"));
walls.push(new Rectangulo(100, 323, 38, 2, "gray"));
...
walls.push(new Rectangulo(299, 327, 45, 2, "gray"));
